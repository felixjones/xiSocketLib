...
Debug: create_folders gccDebug/main.o 
	g++ gccDebug/main.o  $(Debug_Library_Path) $(Debug_Libraries) -Wl,-rpath,./ -o gccDebug/example.01.client.exe
...
Debug: create_folders x64/gccDebug/main.o 
	g++ x64/gccDebug/main.o  $(Debug_Library_Path) $(Debug_Libraries) -Wl,-rpath,./ -o x64/gccDebug/example.01.client.exe
...
Release: create_folders gccRelease/main.o 
	g++ gccRelease/main.o  $(Release_Library_Path) $(Release_Libraries) -Wl,-rpath,./ -o gccRelease/example.01.client.exe
...
Release: create_folders x64/gccRelease/main.o 
	g++ x64/gccRelease/main.o  $(Release_Library_Path) $(Release_Libraries) -Wl,-rpath,./ -o x64/gccRelease/example.01.client.exe
