...
Debug64_Compiler_Flags=-O0 -g -m64
Release_Compiler_Flags=-O2 
Release64_Compiler_Flags=-O2 -m64
...
gccDebug/example.01.client/main.o: main.cpp
	$(CPP_COMPILER) $(Debug_Preprocessor_Definitions) $(Debug_Compiler_Flags) -c main.cpp $(Debug_Include_Path) -o gccDebug/example.01.client/main.o
	$(CPP_COMPILER) $(Debug_Preprocessor_Definitions) $(Debug_Compiler_Flags) -MM main.cpp $(Debug_Include_Path) > gccDebug/example.01.client/main.d
...
x64/gccDebug/example.01.client/main.o: main.cpp
	$(CPP_COMPILER) $(Debug64_Preprocessor_Definitions) $(Debug64_Compiler_Flags) -c main.cpp $(Debug64_Include_Path) -o x64/gccDebug/example.01.client/main.o
	$(CPP_COMPILER) $(Debug64_Preprocessor_Definitions) $(Debug64_Compiler_Flags) -MM main.cpp $(Debug64_Include_Path) > x64/gccDebug/main.d
...
gccRelease/example.01.client/main.o: main.cpp
	$(CPP_COMPILER) $(Release_Preprocessor_Definitions) $(Release_Compiler_Flags) -c main.cpp $(Release_Include_Path) -o gccRelease/example.01.client/main.o
...
x64/gccRelease/example.01.client/main.o: main.cpp
	$(CPP_COMPILER) $(Release64_Preprocessor_Definitions) $(Release64_Compiler_Flags) -c main.cpp $(Release64_Include_Path) -o x64/gccRelease/example.01.client/main.o
	$(CPP_COMPILER) $(Release64_Preprocessor_Definitions) $(Release64_Compiler_Flags) -MM main.cpp $(Release64_Include_Path) > x64/gccRelease/main.d
